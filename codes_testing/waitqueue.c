...
int __init wait_module_init(void) {
	...
	for (int i = 0; i < 4; i++) {
	waiter[i] = kthread_run(waiter_type_1_fn, &index[i], "waiting threads");
	}
	return 0;
}
